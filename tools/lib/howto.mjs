...
export const HOW_TO_LINES = [
  ...
  "  Protection  the device on THIS item's supply side. In the page a",
  "              drop-down offers the whole list every time, with the gear",
  "              that Type usually carries first: ACB CB MCCB MCB VCB RCBO",
  "              LBS Isolator Fuse Fuse-switch Contactor Fused contactor",
  "              Motor starter, and Unknown for a device whose type you",
  "              did not get (the default symbol is drawn, no complaint).",
  "              Blank = the usual default for the Type - and on a Feeder",
  "              it means no device at all. Two supplies: a comma list in",
  "              Feeds From order (LBS, CB). Free text on a busbar",
  "              (87B differential) is printed as a zone label.",
  ...
  "                 A way out of an MV Busbar or an RMU works the same way;",
  "                 carrying nothing it is the outgoing cable, with its",
  "                 arrow. An RMU draws every way's device inside its box,",
  "                 so a way out of one adds none of its own",
  ...
  "    The same on the MV side: a Feeder on the MV Busbar or RMU, then the",
  "    Transformer or MV motor feeding from that Feeder.",
  ...
  "  Protection words: CB MCCB MCB ACB VCB RCBO breaker - LBS isolator",
  "    disconnector switch - Fuse - Fuse-switch SFU switch-fuse -",
  "    Contactor - Fused contactor starter - Unknown TBC (no complaint).",
  "    Anything else draws the default symbol and is reported.",
  "",
  "BACK AT THE OFFICE",
